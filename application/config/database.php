...
$db['default']['hostname'] = 'internal-db.s128431.gridserver.com';
$db['default']['username'] = 'db128431__root';
$db['default']['password'] = 'sonix100';
$db['default']['database'] = 'db128431_bucket';
