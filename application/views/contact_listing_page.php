...
<? } ?>
<p>send a message to <strong><?=$listing['company']?></strong> about the listing <strong><?=$listing['name']?></strong></p>
...
<input name="email_to" value="<?=$listing['email']?>" type="hidden" />
